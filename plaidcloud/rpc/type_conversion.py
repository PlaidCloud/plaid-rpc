...
def arrow_type_from_analyze_type(dtype) -> DataType:
    if dtype == 'date':
        ...
        raise ValueError("Date types are currently not supported in this step type. Please set target column to timestamp and convert to date later if needed.")
